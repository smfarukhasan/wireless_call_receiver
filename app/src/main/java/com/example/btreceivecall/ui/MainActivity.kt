...
class MainActivity : AppCompatActivity() {
    ...
    private fun updateDashboardStatus() {
        ...
        val accStatusText = if (accEnabled) getString(R.string.status_enabled) else getString(R.string.status_disabled)
        ...
        val battStatusText = if (battIgnored) getString(R.string.status_enabled) else getString(R.string.status_disabled)
        binding.tvBattStatusCardValue.text = battStatusText
        binding.tvBattStatusCardValue.setTextColor(ContextCompat.getColor(this, if (battIgnored) R.color.status_green else R.color.status_red))
        binding.layoutBattStatusItem.contentDescription = "${getString(R.string.main_batt_status_title)}: $battStatusText"
    }
