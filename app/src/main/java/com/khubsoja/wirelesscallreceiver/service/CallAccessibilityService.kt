...
class CallAccessibilityService : AccessibilityService() {
    ...
    override fun onServiceConnected() {
        ...
        try {
            ...
            serviceInfo = info
            Log.i(TAG, "onServiceConnected: successfully configured in clean event mode (instance registered).")
        } catch (e: Exception) {
    ...
    override fun onKeyEvent(event: KeyEvent?): Boolean {
        ...
        Log.i(TAG, ">>> ACCESSIBILITY onKeyEvent RECEIVED: code=${KeyEvent.keyCodeToString(keyCode)} ($keyCode), action=${event.action}, state=$callState <<<")
