...
internal object CallAppRegistry {
    const val OWN_PACKAGE = "com.khubsoja.wirelesscallreceiver"
    ...
    fun isSupportedCallPackage(packageName: CharSequence?): Boolean =
        packageName?.toString() in callPackages
}
